...
export default function Header() {
  return (
    <header className="w-full max-w-full">
      ...
      <Link href="/" className="flex items-center gap-4 no-underline bg-white rounded-md px-3 py-4 shadow-sm">
        <div className="relative w-10 h-10 rounded-full overflow-hidden">
          {/* Place your logo file at /public/MFU_logo.png */}
          <Image src="/logo-mfu-v2.png" alt="MFU logo" fill className="object-contain" />
        </div>
